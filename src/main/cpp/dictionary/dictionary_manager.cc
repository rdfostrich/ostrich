...
hdt::IteratorUCharString* DictionaryManager::getSuggestions(const char *prefix, TripleComponentRole role) { return nullptr; }
hdt::IteratorUInt* DictionaryManager::getIDSuggestions(const char *prefix, TripleComponentRole role) { return nullptr; }
