...
TripleComparator get_triple_comparator(TripleComponentOrder order, std::shared_ptr<DictionaryManager> dict1, std::shared_ptr<DictionaryManager> dict2) {
    switch (order) {
        case SPO:
            return {subject_comparator, predicate_comparator, object_comparator, dict1, dict2};
        case SOP:
            return {subject_comparator, object_comparator, predicate_comparator, dict1, dict2};
        case PSO:
            return {predicate_comparator, subject_comparator, object_comparator, dict1, dict2};
        case POS:
            return {predicate_comparator, object_comparator, subject_comparator, dict1, dict2};
        case OSP:
            return {object_comparator, subject_comparator, predicate_comparator, dict1, dict2};
        case OPS:
            return {object_comparator, predicate_comparator, subject_comparator, dict1, dict2};
        case Unknown:
            return {subject_comparator, predicate_comparator, object_comparator, dict1, dict2};
    }
}